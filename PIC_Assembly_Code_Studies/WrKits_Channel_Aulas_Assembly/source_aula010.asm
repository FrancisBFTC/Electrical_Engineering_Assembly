...
Delay500ms:
	...
	movwf 	H'0C'			; Inicializa variável tempo0 (Endereço relativo)
Aux1:						; Já gastou 4 ciclos de máquina
	movlw 	D'250'			; Move o valor 250 para W
	movwf 	H'0D'			; Inicializa variávem tempo1 (Endereço relativo)
...
Aux2:
	...
	nop						; Gasta 1 ciclo de máquina
	nop						; Gasta 1 ciclo de máquina
	decfsz 	H'0D'			; Decrementa tempo1 até que seja igual a 0
	...
	decfsz 	H'0C'			; Decrementa tempo0 até que seja igual a 0
