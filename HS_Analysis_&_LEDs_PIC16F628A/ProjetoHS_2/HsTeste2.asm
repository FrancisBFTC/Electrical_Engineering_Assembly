...
; Clock : 4 MHz
; 
; Programa do 2ª Denominador (s³ + 3s² - 5s + 1) **********************************
; Descrição: Programa que recebe os coeficientes d 2ª Denominador
...
; *****************************************************************************************
; Inicio do Programa:
; 	Coeficientes da Função H(s): Testando 2ª Função -> (s³ + 3s² - 5s + 1)
; *****************************************************************************************
InicioPrograma:
	...
	movlw	D'251'					; Move Coeficiente 251 para Registrador de Trabalho
