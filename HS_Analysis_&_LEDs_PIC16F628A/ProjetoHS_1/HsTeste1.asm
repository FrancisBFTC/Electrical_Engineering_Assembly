...
; Clock : 4 MHz
; 
; Programa do 1ª Denominador (s³+ 3s² + s + 1) **********************************
; Descrição: Programa que recebe os coeficientes do 1ª Denominador
...
; *****************************************************************************************
; Inicio do Programa:
; 	Coeficientes da Função H(s): Testando 1ª Função -> (s³+ 3s² + s + 1)
; *****************************************************************************************
InicioPrograma:
